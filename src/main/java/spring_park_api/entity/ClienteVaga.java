package spring_park_api.entity;
...
public class ClienteVaga {
	...
	@Column(name = "numer_recibo", nullable = false, unique = true, length = 15)
	...
	public ClienteVaga(Long id, String recibo, String placa, String marca, String modelo, String cor,
			LocalDateTime dataEntrada, LocalDateTime dataSaida, BigDecimal valor, BigDecimal desconto,
			LocalDateTime dataCriacao, LocalDateTime dataModificacao, String criadoPor, String modificadoPor) {
		super();
		this.id = id;
		this.recibo = recibo;
		this.placa = placa;
